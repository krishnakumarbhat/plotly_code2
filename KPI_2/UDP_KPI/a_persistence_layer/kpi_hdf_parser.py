...
class KPIHDFParser:
    ...
    def parse_grp(self, group: h5py.Group, header_names) -> None:
        ...
        # (e.g., range / velocity) but still map them to canonical signal keys (e.g., ran / vel).
        stream_config = {}
        for stream_cfg in (
            ...
            if current_stream in stream_cfg:
                stream_config.update(stream_cfg[current_stream])
