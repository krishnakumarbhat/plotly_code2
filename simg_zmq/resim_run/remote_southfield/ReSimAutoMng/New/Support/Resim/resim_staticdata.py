...
# Number of log pairs (e.g. b05/b04, DEBUG/BUS) batched into a single Slurm
# array task/resource allocation in the highPrio (job-array) flow. Batching is
# allowed to span multiple detected nested-session folders (e.g. GPO-V2's
# per-pair test-session folders) so a dataset of N pairs yields ceil(N/PAIRS_PER_JOB)
# jobs instead of one job per pair/session.
PAIRS_PER_JOB = 10
