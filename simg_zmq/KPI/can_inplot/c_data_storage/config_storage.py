...
Gen7V1_V2 = {
    "DETECTION_STREAM": {
        "ran": {
            "aliases": ["ran", "detection_range", "range", "det_range"],
            "call": ["Range"],
            "plot_types": [
        ...
        "vel": {
            "aliases": ["vel", "velocity", "detectionvelocity", "range_velocity", "det_range_velocity"],
            "call": ["Rangerate"],
            "plot_types": [
                "histogram_with_count",
                "scatter_plot",
        ...
        "theta": {
            "aliases": ["theta", "azimuth", "det_azimuth"],
            "call": ["Azimuth"],
            "plot_types": [
        ...
        "phi": {
            "aliases": ["phi", "elevation", "det_elevation"],
            "call": ["elevation"],
            "plot_types": [
                "histogram_with_radtodeg",
                "scatter_plot",
