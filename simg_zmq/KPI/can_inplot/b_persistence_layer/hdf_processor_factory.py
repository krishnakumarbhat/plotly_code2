from can_inplot.b_persistence_layer.allsensor_hdf_parser import AllsensorHdfParser
from can_inplot.b_persistence_layer.Persensor_hdf_parser import PersensorHdfParser
from can_inplot.b_persistence_layer.paired_hdf_processor import PairedHdfProcessor
...
class HdfProcessorFactory:
    ...
    async def process_async(self):
        ...
        try:
            HtmlGenerator.create_timeline_overview(self.output_dir, base_filename="timeline_overview")
        except Exception:
