...
Usage
-----
    python can_intplot_main.py <config.xml> <inputs.json> [output_directory] [plot_config.json]

Also supported:
    python can_intplot_main.py <config.xml> <inputs.json> <plot_config.json> [output_directory]
"""
...
from InteractivePlot.d_business_layer.path_utils import set_default_umask
import asyncio
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3 or len(sys.argv) > 5:
        print(
            "Usage: python can_intplot_main.py <config.xml> <inputs.json> [output_directory] [plot_config.json]"
        )
        print(
            "Also supported: python can_intplot_main.py <config.xml> <inputs.json> <plot_config.json> [output_directory]"
        )
        sys.exit(1)
