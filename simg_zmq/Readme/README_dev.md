...
flowchart LR
    ...
    Broker --> IntPlot[udp_intplot_kpi.simg]
...
| `simg_zmq/simg_sh_hpcc/kpi/int_plot/udp_intplot_kpi.simg` | generated container image | Runs Interactive Plot generation. Used by `run_intplot.sh`. |
...
- `simg_sh_hpcc/kpi/int_plot/udp_intplot_kpi.simg`
...
scp simg_sh_hpcc/kpi/int_plot/udp_intplot_kpi.simg <user>@<cluster-host>:/path/to/simg_sh_hpcc/kpi/int_plot/
