...
COV_SKIP_FILES = [
    # Always skip 3rd party code
    ".*iND13400_autosar_sip/.*",
    ".*iND13400_sdk/.*",
] + select({
    # Don't skip autogenerated files for nightly builds
    "//tools/coverity:coverityNightly": [],
    # But do skip autogenerated files for regular/verification builds
    "//conditions:default": [
...
def register_predefined_coverity(major_version, register_toolchains = True):
    ...
    licence_sha256 = "b8e1f5c7e17641effa2a552501f4b46fc44dcf19c5b9df3fbafe098981599c74"
    licence_url = "https://jfrog.asux.aptiv.com/artifactory/bazel_tools_internal-generic-local/coverity/licences/license_06_07_2027.dat"
