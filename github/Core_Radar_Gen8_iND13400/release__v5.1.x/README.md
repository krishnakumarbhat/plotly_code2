...
3) Variant: Standalone with Disabled CAN and Someip:
    Standalone (no CAN, no SOMEIP, tracker present):
    FLR8: bazelisk build //:gen8 --config=flr8 --veh_com=none --tracker_variant=platform_flr8_standalone --board=B0 --mars_hw_rev=B0
    SRR8P: bazelisk build //:gen8 --config=srr8p --veh_com=none --tracker_variant=platform_srr8p_standalone --board=B0 --mars_hw_rev=B0
...
Examples:
bazelisk build //:gen8 --config=flr8 --veh_com={placeholder} --tracker_variant=disabled
bazelisk build //:gen8 --config=flr8 --veh_com={placeholder} --tracker_variant=partner_sensor
bazelisk build //:gen8 --config=flr8 --veh_com=none --tracker_variant=platform_flr8_standalone
bazelisk build //:gen8 --config=srr8p --veh_com=none --tracker_variant=platform_srr8p_standalone
bazelisk build //:gen8 --config=srr8p --veh_com=none --tracker_variant=platform_srr8p_2_sensor_fusion
bazelisk build //:gen8 --config=srr8p --veh_com=al_can_standalone --tracker_variant=AL
