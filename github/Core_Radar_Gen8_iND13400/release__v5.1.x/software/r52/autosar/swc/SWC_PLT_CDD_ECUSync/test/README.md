...
.\bazelisk test //software/r52/autosar/swc/SWC_PLT_CDD_ECUSync/test:SWC_PLT_CDD_ECUSync_unit_test

# Run with detailed output
.\bazelisk test //software/r52/autosar/swc/SWC_PLT_CDD_ECUSync/test:SWC_PLT_CDD_ECUSync_unit_test --test_output=all
```
