...
--chandra_hw_rev boardVersion option is default set to B0 as well for CICD (software/r52/BUILD)
...
1) Variant: Satellite-CAN/ Default:
    ...
    FLR8: bazelisk build //:gen8 --config=flr8 --veh_com=can --chandra_hw_rev=B0 --mars_hw_rev=B0
    SRR8P: bazelisk build //:gen8 --config=srr8p --veh_com=can --chandra_hw_rev=B0 --mars_hw_rev=B0
    or
...
2) Variant: Satellite-Eth_Someip_HighDet:
    ...
    FLR8: bazelisk build //:gen8 --config=flr8 --veh_com=someip --chandra_hw_rev=B0 --mars_hw_rev=B0
    SRR8P: bazelisk build //:gen8 --config=srr8p --veh_com=someip --chandra_hw_rev=B0 --mars_hw_rev=B0
...
3) Variant: Standalone with Enabled CAN and Disabled Someip:
    ...
    FLR8: bazelisk build //:gen8 --config=flr8 --veh_com=can_standalone --tracker_variant=platform_flr8_standalone --chandra_hw_rev=B0 --mars_hw_rev=B0
    SRR8P: bazelisk build //:gen8 --config=srr8p --veh_com=can_standalone --tracker_variant=platform_srr8p_standalone --chandra_hw_rev=B0 --mars_hw_rev=B0
...
4) Variant: AL SRR8p specific: Standalone with Enabled CAN:
    ...
    SRR8P: bazelisk build //:gen8 --config=srr8p --veh_com=al_can_standalone --tracker_variant=AL --chandra_hw_rev=B0 --mars_hw_rev=B0
...
bazelisk build //:gen8 --config=srr8p --veh_com=can_standalonene --tracker_variant=platform_srr8p_2_sensor_fusion --chandra_hw_rev=B0 --mars_hw_rev=B0
...
#### Enable SQT Artiemem fault stubs
