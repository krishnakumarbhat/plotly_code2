def EMB_TRACKER_PROJECT_PROFILE():
    ...
    return struct(
        ...
        RSPP_VARIANT_TEMPLATE =
            select({
                "@emb_tracker_wrapper//:platform_flr8_standalone": "RSPP/include/variants/rspp_variant_definition_g.h",
                "@emb_tracker_wrapper//:platform_srr8p_standalone": "RSPP/include/variants/rspp_variant_definition_j.h",
                "@emb_tracker_wrapper//:platform_srr8p_2_sensor_fusion": "RSPP/include/variants/rspp_variant_definition_r.h",
                "@emb_tracker_wrapper//:AL": "RSPP/include/variants/rspp_variant_definition_al.h",
                "//conditions:default": "RSPP/include/variants/rspp_variant_definition_j.h",
            }),
        RSPP_VARIANT_SUBS =
            select({
                "@emb_tracker_wrapper//:platform_flr8_standalone": {"rspp_variant_G": "rspp_variant_A"},
                "@emb_tracker_wrapper//:platform_srr8p_standalone": {"rspp_variant_J": "rspp_variant_A"},
                "@emb_tracker_wrapper//:platform_srr8p_2_sensor_fusion": {"rspp_variant_R": "rspp_variant_A"},
                "@emb_tracker_wrapper//:AL": {"rspp_variant_AL": "rspp_variant_A"},
                "//conditions:default": {"rspp_variant_J": "rspp_variant_A"},
            }),
        ...
        TRAILER_MANAGER_DISABLE_DEFINES =
            select({
                ...
                "@emb_tracker_wrapper//:platform_srr8p_standalone": ["DISABLE_TRAILER_MANAGER"],
                "@emb_tracker_wrapper//:platform_srr8p_2_sensor_fusion": ["DISABLE_TRAILER_MANAGER"],
                "@emb_tracker_wrapper//:AL": ["DISABLE_TRAILER_MANAGER"],
        ...
        OCG_SG_DISABLE_DEFINES =
            select({
                ...
                "@emb_tracker_wrapper//:platform_srr8p_standalone": ["DISABLE_SG"],
                "@emb_tracker_wrapper//:platform_srr8p_2_sensor_fusion": ["DISABLE_SG"],
        ...
        OCG_SG_HDRS =
            select({
                ...
                "@emb_tracker_wrapper//:platform_srr8p_standalone": ["ROT/Fusion360/track_classification/include/f360_assign_underdrivability_status_to_tracks_ocg.h"],
                "@emb_tracker_wrapper//:platform_srr8p_2_sensor_fusion": ["ROT/Fusion360/track_classification/include/f360_assign_underdrivability_status_to_tracks_ocg.h"],
        ...
        OCG_SG_SRCS =
            select({
                ...
                "@emb_tracker_wrapper//:platform_srr8p_standalone": ["ROT/Fusion360/track_classification/source/f360_assign_underdrivability_status_to_tracks_ocg.cpp"],
                "@emb_tracker_wrapper//:platform_srr8p_2_sensor_fusion": ["ROT/Fusion360/track_classification/source/f360_assign_underdrivability_status_to_tracks_ocg.cpp"],
        ...
        OCG_DEPS =
            select({
                ...
                "@emb_tracker_wrapper//:platform_srr8p_standalone": ["@rotbb//emb_tracker:ocg"],
                "@emb_tracker_wrapper//:platform_srr8p_2_sensor_fusion": ["@rotbb//emb_tracker:ocg"],
