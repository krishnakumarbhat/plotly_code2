...
### Build command
bazelisk build //:gen8 --config=flr8 --disable_int_wdg --//:static_register_safety_enabled=false
bazelisk build //:gen8 --config=srr8p --disable_int_wdg --//:static_register_safety_enabled=false
