...
| [`--enable_limited_frame_per_call`](#stream-chunkframes-tx-per-5ms-call) | `false` | Limited frames tx per 5ms call |
...
### Stream chunk/frames Tx per 5ms call

```text
--enable_limited_frame_per_call         : enable streams chunk/frames Tx per 5ms call
--enable_limited_frame_per_call=true    : enable streams chunk/frames Tx per 5ms call
--enable_limited_frame_per_call=false   : disable streams chunk/frames Tx per 5ms call
```

By default `enable_limited_frame_per_call` is `false`.
