...
MAX_TARGET_REPORTS_TRACKER_BUILD = 128  # used for stream 16 calculation
AF_MAX_NUM_DET = 2048  # used for stream 1 and 15 calculation
MAX_NUMBER_OF_PARTNER_SENSORS = 1  # used for stream 16 calculation
            ...
            for line in file_1:
                ...
                if -1 == dynstart:
                    ...
                    if "str001" in filename:
                        ...
                        stream_size = static_size + dynamic_size * AF_MAX_NUM_DET
                    elif "str016" in filename:
                        stream_size = (
                            static_size
                            + dynamic_size
                            * MAX_TARGET_REPORTS_TRACKER_BUILD
                            * MAX_NUMBER_OF_PARTNER_SENSORS
                        )
                    elif "str021" in filename:
                        stream_size = static_size + dynamic_size * MAX_TARGET_REPORTS
                    elif "str022" in filename:
                        stream_size = static_size + dynamic_size * MAX_TARGET_REPORTS
                    else:
