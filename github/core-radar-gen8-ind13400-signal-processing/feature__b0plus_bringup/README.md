...
## Doppler proc related
       ...
       bazelisk build //modules/doppler_process/test/unit_test/simulator:circ_shift_ops_sim_with_summary
...
## REST MAP Doppler processing related

       (To Build the doppler REST-MAP processing test cases)
       bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb --//modules/doppler_process/test/testdata:test_select=rbin17 --bbe_asic_fpga=b0_fpga --verbose_failures
...
## Mipi related
       ...
       bazelisk build //modules/helpers/test/embedded/mipi:mipi_idm_test --bbe_asic_fpga=b0_fpga --copt="-DENABLE_HELPERS_SFR_DEBUG" --copt="-DMIPI_HELPERS_DEBUG_ENABLE"
...
## RA and Range proc related
       ...
       bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookC --bbe_asic_fpga=b0_fpga --verbose_failures
       bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookD --bbe_asic_fpga=b0_fpga --verbose_failures

       For B0 FPGA only(not ASIC) : due to CSI emulator usage
       bazelisk build @build_config//:chandra_sfr_h --bbe_asic_fpga=b0_fpga --verbose_failures
...
1. spbb_cfg
   - Provides the build time configurations for the modules in bb_cfg.h.
