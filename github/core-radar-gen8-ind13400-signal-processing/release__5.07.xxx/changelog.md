...
## Version 5.07
### Revision 001
- Updated doppler commands for prep and post scaling usage, along with estimator shift for REST threshold.

## Version 5.07
### Revision 002
- AL Small classical signal processing with 512 chirps doppler cmd config update

## Version 5.07
### Revision 003
- AL Small classical signal processing with right shift estimator fix

## Version 5.07
### Revision 004
- AL Small classical REST issue Fix - fftgain4 was 2 , needs to be 1 for 512 doppler size
