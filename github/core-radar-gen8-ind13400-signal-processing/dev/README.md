...
## RA and Range proc related
       ...
       (48bit compression fddt)
       bazelisk build //modules/range_process/test:example_luna_48b_fddt_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookB --bbe_asic_fpga=b0_asic
       ...
       ENABLE_BIGBV_REORDER = 0U
       bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb_qddma_48b --//modules/doppler_process/test/testdata:test_select=rbin17  --bbe_asic_fpga=b0_asic--//common:bigbv_reorder_enabled=False

        bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb_qddma --//modules/doppler_process/test/testdata:test_select=rbin17  --bbe_asic_fpga=b0_asic --//common:range_datacube_48_bit_disabled=True --//common:bigbv_reorder_enabled=False

        ENABLE_BIGBV_REORDER = 1U
        bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb_bigbv_qddma_48b --//modules/doppler_process/test/testdata:test_select=rbin17  --bbe_asic_fpga=b0_asic --//common:bigbv_reorder_enabled=True
