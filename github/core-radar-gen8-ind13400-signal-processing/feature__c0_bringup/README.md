...
## RA and Range proc related
       ...
       bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookB --bbe_asic_fpga=b0_fpga --verbose_failures
       bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookC
       ...
       (48bit compression)
       bazelisk build //modules/range_process/test:example_luna_48b_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookA --bbe_asic_fpga=b0_asic

       bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookA --bbe_asic_fpga=b0_asic --//common:range_datacube_48_bit_disabled=True

       bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb_qddma_48b --//modules/doppler_process/test/testdata:test_select=rbin17  --bbe_asic_fpga=b0_asic

        bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb_qddma --//modules/doppler_process/test/testdata:test_select=rbin17  --bbe_asic_fpga=b0_asic --//common:range_datacube_48_bit_disabled=True

       bazelisk build //modules/range_process/test:example_luna_48b_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookA --bbe_asic_fpga=c0_fpga

       bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb_qddma_48b --//modules/doppler_process/test/testdata:test_select=rbin17  --bbe_asic_fpga=c0_fpga

        bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookA --bbe_asic_fpga=c0_fpga --//common:range_datacube_48_bit_disabled=True
...
## C0 FPGA related(48bit compression and Cache Evaluation pre-tapeout)

       (Builds for the Helper modules)
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:idma_test --bbe_opt=O2 --bbe_profile_timing=ns
       bazelisk clean && bazelisk build //internal/bbe32:example_luna_test_app_emb --bbe_asic_fpga=b0_fpga

       bazelisk clean && bazelisk build //modules/helpers/test/embedded/mipi:mipi_test --bbe_asic_fpga=b0_fpga
       bazelisk build //modules/helpers/test/embedded/mipi:mipi_resto_idm_test --bbe_asic_fpga=b0_fpga --copt="-DENABLE_HELPERS_SFR_DEBUG" --copt="-DMIPI_HELPERS_DEBUG_ENABLE" --verbose_failures

       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:idma_test --bbe_asic_fpga=b0_fpga --bbe_opt=O2 --bbe_profile_timing=ns
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:non_fito_test --bbe_asic_fpga=b0_fpga(Obsolete in C0, as this mode will no longer be supported)
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:fito_test --bbe_asic_fpga=b0_fpga (study and rework this test to be upgraded for 48bit layout understanding)
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:profiling_tests --bbe_asic_fpga=b0_fpga/c0_fpga
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:cache_test (not for FPGA, only on EVB)
       bazelisk clean && bazelisk build //modules/helpers/af_module:flr8_angle_finding_module_lib (WIP, when this is ready ...we can use this for further Cache analysis)

       bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookA --bbe_asic_fpga=b0_asic --verbose_failures
       bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookB --bbe_asic_fpga=b0_asic --verbose_failures
       bazelisk build //modules/range_process/test:example_luna_test_app_emb --//modules/range_process/test/testdata:range_test_select=LookC --bbe_asic_fpga=b0_asic --verbose_failures
       bazelisk build //modules/range_process/test:example_luna_test_app_emb --//modules/range_process/test/testdata:range_test_select=LookD --bbe_asic_fpga=b0_asic --verbose_failures

       bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb_qddma --//modules/doppler_process/test/testdata:test_select=rbin17
       bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb --//modules/doppler_process/test/testdata:test_select=rbin17
...
### Adding unit tests\
To run the module wise unit tests
common:                   bazelisk test //common/unit_test:all_tests
cfar:                     bazelisk test //modules/cfar/test/unit_test:all_tests
doppler_process:          bazelisk test //modules/doppler_process/test/unit_test:all_unit_tests
helpers:                  bazelisk test //modules/helpers/test/unit_test:all_tests
range_process:            bazelisk test //modules/range_process/test/unit_test:all_unit_tests
rdd_first_pass_process:   bazelisk test //modules/rdd_first_pass_process/test/unit_test:all_tests
second_pass:              bazelisk test //modules/second_pass/test/unit_test:all_tests
sweep_bw:                 bazelisk test //modules/sweep_bw/test/unit_test:all_tests
...
# B0 Commands supported under this repo are a follows:
       bazelisk clean && bazelisk build //internal/bbe32:example_luna_test_app_emb --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/mipi:mipi_test --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:fito_test --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:profiling_tests --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:cache_test --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/aux_acc:example_luna_test_app_emb --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:idma_test --bbe_opt=O2 --bbe_profile_timing=ns --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:idma_test --bbe_asic_fpga=b0_asic --bbe_opt=O2 --bbe_profile_timing=ns
       bazelisk clean && bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=False --//common:range_datacube_48_bit_disabled=True --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=False --//modules/range_process/test/testdata:range_test_select=LookA --bbe_asic_fpga=b0_asic --//common:range_datacube_48_bit_disabled=True
       bazelisk clean && bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookA --bbe_asic_fpga=b0_asic --//common:range_datacube_48_bit_disabled=True
       bazelisk clean && bazelisk build //modules/range_process/test:example_luna_48b_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookA --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/range_process/test:example_luna_test_app_emb --enable_adc_log=True --//modules/range_process/test/testdata:range_test_select=LookA --bbe_asic_fpga=b0_asic --//common:range_datacube_48_bit_disabled=True
       bazelisk clean && bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb --//modules/doppler_process/test/testdata:test_select=rbin17 --bbe_asic_fpga=b0_asic --//common:range_datacube_48_bit_disabled=True
       bazelisk clean && bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb_qddma --//modules/doppler_process/test/testdata:test_select=rbin17 --bbe_asic_fpga=b0_asic --//common:range_datacube_48_bit_disabled=True
       bazelisk clean && bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb --//modules/doppler_process/test/testdata:test_select=rbin17 --//common:range_datacube_48_bit_disabled=True --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/doppler_process/test:example_luna_test_restmap_app_emb_qddma_48b --//modules/doppler_process/test/testdata:test_select=rbin17  --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/doppler_process/test/unit_test/simulator:transpose_ops_sim --bbe_opt=O2 --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/rdd_first_pass_process/test:3d_map_fun_test_emb --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/rdd_first_pass_process/test/sim:simulate_frac_bin_test --bbe_opt=O2 --bbe_profile_timing=ns --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/rdd_first_pass_process/test/sim:simulate_extract_bv_test --bbe_opt=O2 --bbe_profile_timing=ns --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/second_pass/test/sim:simulate_functional_test --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/doppler_process/test/unit_test/simulator:transpose_ops_sim --bbe_opt=O2 --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //modules/helpers/test/embedded/sysmem:idma_test --bbe_asic_fpga=b0_asic --bbe_opt=O2 --bbe_profile_timing=ns --bbe_asic_fpga=b0_asic
       bazelisk clean && bazelisk build //internal/bbe32:example_test_app_sim_c0_show_summary --bbe_asic_fpga=b0_fpga
       bazelisk clean && bazelisk build //internal/bbe32:example_luna_test_app_emb --bbe_asic_fpga=b0_fpga
