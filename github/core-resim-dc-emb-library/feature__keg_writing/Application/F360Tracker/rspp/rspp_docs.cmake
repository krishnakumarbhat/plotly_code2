...
if(FALSE) # TODO: Re-enable when RSPP has a version definition
...
set(PROJECT_VERSION_DOCSTRING "Version 0.1.0")
...
if(EXISTS ${common_conf_dir}/junit2pdf-utr.xsl)
  ...
  add_custom_target(rspp-utr
    COMMAND ${CMAKE_COMMAND} -E echo "RSPP-UTR PDF generation moved to bash script."
    ...
    # -pdf ${CMAKE_CURRENT_BINARY_DIR}/doc/RSPP_UTR.pdf
