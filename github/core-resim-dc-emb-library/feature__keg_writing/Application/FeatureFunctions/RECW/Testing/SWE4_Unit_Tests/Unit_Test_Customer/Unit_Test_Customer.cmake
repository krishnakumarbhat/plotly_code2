...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/${RECW_PROJECT_VARIANT})
   include(${CMAKE_CURRENT_LIST_DIR}/${RECW_PROJECT_VARIANT}/UT_${RECW_PROJECT_VARIANT}.cmake)
else()
   if(NOT ${RECW_PROJECT_VARIANT} MATCHES Generic)
