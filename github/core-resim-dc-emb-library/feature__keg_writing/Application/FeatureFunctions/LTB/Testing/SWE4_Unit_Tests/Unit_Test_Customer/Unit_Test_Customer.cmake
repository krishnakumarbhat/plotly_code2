...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/${LTB_PROJECT_VARIANT})
   include(${CMAKE_CURRENT_LIST_DIR}/${LTB_PROJECT_VARIANT}/UT_${LTB_PROJECT_VARIANT}.cmake)
else()
   if(NOT ${LTB_PROJECT_VARIANT} MATCHES Generic)
