...
tar="resim_veh_$1_radar_$2_dc_$3.tar"
simg="resim_veh_$1_radar_$2_dc_$3.simg"
...
echo "        ./APT_SRR_RESIM ./SIL_Engine_Config.xml \$1 \$2" >>RUN_VV.sh
...
docker rmi -f resim_veh_$1_radar_$2_dc_$3:lm1-apt_srr_resim__lm1-sensor-csrr_ >/dev/null 2>&1

# docker build process starts here
echo ""
echo "***** Docker build has started *****"
docker build -t resim_veh_$1_radar_$2_dc_$3 --network=host .
docker tag resim_veh_$1_radar_$2_dc_$3:latest resim_veh_$1_radar_$2_dc_$3:lm1-apt_srr_resim__lm1-sensor-csrr_
docker rmi -f resim_veh_$1_radar_$2_dc_$3:latest
docker save -o resim_veh_$1_radar_$2_dc_$3.tar resim_veh_$1_radar_$2_dc_$3
chmod 777 resim_veh_$1_radar_$2_dc_$3.tar
...
singularity build resim_veh_$1_radar_$2_dc_$3.simg docker-archive://resim_veh_$1_radar_$2_dc_$3.tar # building singularity image from docker image
...
echo "" >> GEN_LOG.sh
echo "	docker run -it -v \$(pwd)/INPUT_LOGS/:/input/ -v \$(pwd)/:/output/ resim_veh_$1_radar_$2_dc_$3:lm1-apt_srr_resim__lm1-sensor-csrr_ /RUN_VV.sh \"\$@\" ;echo \$?" >> GEN_LOG.sh
echo "" >> GEN_LOG.sh
...
echo "singularity exec \$(pwd)/resim_veh_$1_radar_$2_dc_$3.simg /RUN_VV.sh \$(pwd)/SIL_Input.txt \$(pwd)/OUTPUT_DIR" >> Run_Singularity.sh
echo "" >> Run_Singularity.sh
...
rm -rf RUN_VV.sh		# removing RUN_RESIM.sh
