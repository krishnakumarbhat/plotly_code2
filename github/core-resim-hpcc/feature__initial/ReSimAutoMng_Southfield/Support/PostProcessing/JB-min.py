        ...
        if line >= currLine and versionCaptured == True:
            ...
            if content[2] == ' OOM     ':
                ...
                if content[12] ==  ' Running':
                    if content[11] == ' False  ': logsOOM += failed_logs
...
#creating Pie chart for Pass-fail yield
    ...
    logs_unknown = max(logsTotal - (logsResimulated + logsCrashed + logsBad + logsBusspecId + logsTimeout + logsOOM + logsPCalib + logsFCalib + logsMdf), 0)
