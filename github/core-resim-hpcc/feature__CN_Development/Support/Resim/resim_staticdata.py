...
if 'projects' in hpcc:
    ...
    server = "PROJECTS/"
    inputfile = "/net/8k3/e0fs01/irods/PLKRA-PROJECTS/CEER-PROGRAM/4-Checkout/Resim_Pipeline/Core_RESIM_HPCC/Support/PostProcessing/support_files.txt"
    splitter_path = "/net/8k3/e0fs01/irods/PLKRA-PROJECTS/CEER-PROGRAM/4-Checkout/Resim_Pipeline/Core_RESIM_HPCC/Shell/splitter_highPrio.sh"
    resimMining = "python /net/8k3/e0fs01/irods/PLKRA-PROJECTS/CEER-PROGRAM/4-Checkout/Resim_Pipeline/Core_RESIM_HPCC/Support/PostProcessing/JB-min.py"
    statsMining = "python /net/8k3/e0fs01/irods/PLKRA-PROJECTS/CEER-PROGRAM/4-Checkout/Resim_Pipeline/Core_RESIM_HPCC/Support/PostProcessing/stats_mining.py"
    sourceEnv = "source /net/8k3/e0fs01/irods/PLKRA-PROJECTS/CEER-PROGRAM/4-Checkout/Environment/env/bin/activate"
    input_parameter.append("/net/8k3/e0fs01/irods/PLKRA-PROJECTS/CEER-PROGRAM/4-Checkout/Resim_Pipeline/Core_RESIM_HPCC/Shell/rResim_main_highPrio.sh")
    load_simg = "module load singularity/3.11.4_no_local"
    simg_exec = "singularity exec --no-mount /local --bind /app:/app"
