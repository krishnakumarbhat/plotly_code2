...
if [[ -d "/mnt/usmidet/projects/GPO-IFV7XX" ]]; then
    ...
    python /mnt/usmidet/projects/GPO-IFV7XX/4-Checkout/Resim_Pipeline/Core_RESIM_HPCC/Support/Resim/resim_main.py "$@"
    deactivate
    ...
    module load slurm
    python /net/8k3/e0fs01/irods/PLKRA-PROJECTS/CEER-PROGRAM/4-Checkout/Resim_Pipeline/Core_RESIM_HPCC/Support/Resim/resim_main.py "$@"
    deactivate
