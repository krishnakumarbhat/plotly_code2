...
def _impl_cc_toolchain_config(ctx):
        ...
        env_sets = [
            env_set(
                ...
                env_entries = [
                              ...
                              [
                                  env_entry(key = "XTENSA_LICENSE_RETRIES", value = "1440:10"),
                              ],
            ),
        ],
    )
    ...
    features = [
        ...
        user_compile_flags_feature,  # Let user override compiler defaults by putting user_compile_flags_feature after lto_feature and default_compiler_flags
        default_linker_flags,
        user_link_flags_feature,  # Let user override linker defaults by putting user_link_flags_feature after default_linker_flags
