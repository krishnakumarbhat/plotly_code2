...
**Repository**: GPO/core-radar-gen8-s32r47-signal-processing
**Generated**: 2026-08-31 06:49:39 UTC
**Total Rulesets**: 7
...
- **Enforcement**: active
- **Target**: branch
- **Created**: 2026-08-31T06:15:09.229Z
- **Last Updated**: 2026-08-31T06:48:22.631Z
...
- **Required Status Checks**:
  - `verify / Check Documentation Changes`
  - `verify / Validate PR JIRA Tickets / pr-validation`
  - `verify / Prepare Variant Matrix`
  - `verify / Precommit / Pre-commit`
  - `verify / Unit Tests (${{ (((matrix.variant != '') && matrix.variant) || 'default') }})`
  - `verify / Build (${{ (((matrix.variant != '') && matrix.variant) || 'default') }})`
...
- **Enforcement**: active
- **Target**: tag
- **Created**: 2026-08-31T06:15:09.690Z
- **Last Updated**: 2026-08-31T06:15:09.789Z
