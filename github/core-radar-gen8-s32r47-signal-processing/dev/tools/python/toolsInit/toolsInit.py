...
class tool:
    ...
    def __init__(
        ...
        Args:
            ...
            initCmd: A list of strings that should be run to initialzed the tool when runInitCmd is True Default: None
        """
        self.name = name
    ...
    def initTool(self):
        ...
        """
        print("Attempting to initialze " + self.name + "...")
...
class toolsInit:
    ...
    def addTrace32Tool(self):
        ...
        trace32Tool = tool(
            "trace32",
            "https://jfrog.asux.aptiv.com/artifactory/gen7-aptiv-advradar-3rd_party-generic-local/trace32/T32_2023_03_157821.zip",  # noqa: E501
            t32InstallDir,
            "t32.zip",
            unzipFile=True,
        )
...
if __name__ == "__main__":
    ...
    # If no specific tool is provided, download all tools.
    if not args.trace32:
        args.trace32 = True
