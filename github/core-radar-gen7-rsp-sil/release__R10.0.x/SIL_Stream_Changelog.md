...
#### The data needed to calculate the IDM information in the second pass comes from the Rfft_Data_T structure (rfft_data) of the RDD stream. This signal is added into the SIL_RDD_Data_T and needs to be copied. If this is not populated correctly, the related IDM artifact masking outputs will be impacted.
