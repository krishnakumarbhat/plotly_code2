...
config_path = os.path.join(project_root, 'Data', 'Aptiv_Libraries', 'DEFAULT_CONFIG_XMLS', customer)
fw_lime_path = os.path.join(project_root, 'Data', 'Aptiv_Libraries', 'FW_LIME')
radar_dlls_path = os.path.join(project_root, 'Data', 'Aptiv_Libraries', 'RADAR_DLLS', customer)
dc_path = os.path.join(project_root, 'Data', 'Aptiv_Libraries', 'DC', customer)
