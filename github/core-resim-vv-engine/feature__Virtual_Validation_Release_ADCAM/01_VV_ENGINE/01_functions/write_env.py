...
write_envvar("Path", os.path.abspath(r"Binaries\Windows\SM2_LM2_FMU_Binaries\LogicalModel\binaries\win64"))
write_envvar("Path", os.path.abspath(r"Binaries\Windows\SM2_LM2_FMU_Binaries\LogicalModel\binaries\win64"), False)
