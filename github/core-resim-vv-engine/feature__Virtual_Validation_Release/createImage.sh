...
echo "        ./SensorModelSilEngine ./VVEngineConfig.yaml \$1 \$2" >>RUN_VV.sh
...
singularity build resim_vv_$1_$2_$3.simg docker-archive://resim_vv_$1_$2_$3.tar # building singularity image from docker image
