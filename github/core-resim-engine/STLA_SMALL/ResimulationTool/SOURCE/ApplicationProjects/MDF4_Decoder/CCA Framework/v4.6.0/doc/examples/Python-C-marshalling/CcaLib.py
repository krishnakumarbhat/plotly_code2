...
#
# @copyright            Copyright (c) 2016-2024 ViGEM GmbH. All rights reserved.
#
# @file                 CcaLib.py
#
# @date                 2024-09-05
...
if platform.system() == 'Windows':
    CCA_LIBRARY_NAME = R"C:\Program Files\ViGEM GmbH\CCA Framework MDF\v4.6.0\bin\ccalib_mdf_x64_4.6.0.dll"
else:
    CCA_LIBRARY_NAME = "../../../../../lib/libccalib_mdf_x64_4.6.0.so"
CCA_PY_VERSION = "4.6.0"
