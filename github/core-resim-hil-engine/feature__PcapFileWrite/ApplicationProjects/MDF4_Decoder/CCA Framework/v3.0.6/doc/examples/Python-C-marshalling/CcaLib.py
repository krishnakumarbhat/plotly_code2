...
#
# @copyright            Copyright (c) 2016-2021 ViGEM GmbH. All rights reserved.
#
# @file                 CcaLib.py
#
# @date                 2021-05-21
...
if platform.system() == 'Windows':
    CCA_LIBRARY_NAME = R"C:\Program Files\ViGEM GmbH\CCA Framework MDF\v3.0.6\bin\ccalib_mdf_x64_3.0.6.dll"
else:
    CCA_LIBRARY_NAME = "../../../../../lib/libccalib_mdf_x64_3.0.6.so"
CCA_PY_VERSION = "3.0.6"
