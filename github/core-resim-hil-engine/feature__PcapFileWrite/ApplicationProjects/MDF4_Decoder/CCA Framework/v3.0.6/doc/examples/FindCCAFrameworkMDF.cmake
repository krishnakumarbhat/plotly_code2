# CMake finc script for the ${FRAMEWORK_NAME_DASH}.
# 
# @copyright            Copyright (c) 2017-${ccalib_CURRENT_YEAR} ViGEM GmbH. All rights reserved
# 
# @file                 FindCCAFrameworkMDF.cmake
# 
# @date                 ${ccalib_CURRENT_DATE}
# @version              ${ccalib_VERSION}
# @license              For licensing information, please see "Terms and Conditions of Use.rtf"

set(CCAFrameworkMDF_ARCH "x64" CACHE STRING "Target architecture.")
set(CCAFrameworkMDF_VERSION "3.0.6" CACHE STRING "Framework Version.")
