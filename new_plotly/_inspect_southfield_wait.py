...
command = "source /etc/profile.d/modules.sh 2>/dev/null; module load slurm 2>/dev/null; srun --jobid=43612262 --overlap --ntasks=1 ps -o pid,ppid,state,wchan:32,etime,args -p 2833926,2834295 2>&1"
