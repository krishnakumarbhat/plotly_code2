...
stdin, stdout, stderr = client.exec_command(f"bash -lc '{setup} squeue -j 21220080'", timeout=20)
print(stdout.read().decode())
stdin, stdout, stderr = client.exec_command(f"bash -lc '{setup} scontrol show job 21220080'", timeout=20)
print(stdout.read().decode())
client.close()
