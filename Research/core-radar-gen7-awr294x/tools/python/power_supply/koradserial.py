...
class KoradSerial(object):
    ...
    class Channel(object):
        ...
        def voltage(self):
            ...
            return float_or_none(
                self.__serial.send_receive("VSET{0}?".format(self.number), fixed_length=5)
            )
    ...
    class Serial(object):
        ...
        def __init__(self, port, debug=False):
            ...
            try:
                ...
                print(
                    "\nERROR: Unable to connect to port {0} for the power supply. Verify the port is available and not already in use.\n".format(
                        port
                    )
                )
    ...
    def __init__(self, port, debug=False):
        ...
        self.connected = self.__serial.connected
