...
class PowerCtrl:
    ...
    def __init__(self) -> None:
        ...
        raise ConnectionError("No supported Power Supply Found")
    ...
    def serial_config(self, com_port: str, timeout_s: float = 0.1) -> serial.Serial:
        ...
        serialPort = serial.Serial(baudrate=9600,
                                   bytesize=8,
                                   timeout=timeout_s,
    ...
    def read_from_command(self, command: str, attempts: int = COMMAND_RETRY_ATTEMPTS) -> float | str:
        """
