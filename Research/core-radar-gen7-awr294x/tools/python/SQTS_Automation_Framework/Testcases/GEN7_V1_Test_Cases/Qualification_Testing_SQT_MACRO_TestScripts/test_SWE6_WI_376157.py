...
@pytest.mark.WI("WI_376157")
@pytest.mark.description("Write of QM application by QM application")
def test_MCU_Configuration_And_Supervision(Power, T32_R5A, T32_C66, Report):
    ...
    if condition == 1:
        ...
        time.sleep(0.5)
        print("MpuTestCase to MPU_MSS_L2_QM_WRITE_ACCESS_QM")
        if T == 3:
            print(t, " ", T_1[T])
            condition_1 = 1
