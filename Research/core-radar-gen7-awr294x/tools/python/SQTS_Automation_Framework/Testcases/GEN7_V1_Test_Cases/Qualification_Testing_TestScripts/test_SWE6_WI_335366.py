...
@pytest.mark.WI("WI_335366")
@pytest.mark.description("Qualification test validation for RF Health Monitor Enable - Positive Test Case")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    temp_1 = "SMC_Cal_Data.Radar_Health_Cal.k_rfhealth_algo_enable_str"
    TEMP_1 = T32_R5A.read_var(temp_1)
    print("Value of SMC_Cal_Data.Radar_Health_Cal.k_rfhealth_algo_enable_str is", "=", TEMP_1)
    temp_2 = "MMIC_Stream.MMIC_Data.RFHealth_Status.RFHealth_EnableStatusFlag"
    TEMP_2 = T32_R5A.read_var(temp_2)
    print("Value of MMIC_Stream.MMIC_Data.RFHealth_Status.RFHealth_EnableStatusFlag is", "=", TEMP_2)
    temp_3 = "RFHealth_EnableStatusFlag"
    TEMP_3 = T32_R5A.read_var(temp_3)
    print("Value of RFHealth_EnableStatusFlag is", "=", TEMP_3)
    print("")
    print("-----------------------------------WI-335366 :END-------------------------------------")
    time.sleep(2)
    condition = 0
    if TEMP_1 == 1 and TEMP_2 == 1 and TEMP_3 == 1 and flag :
        print("Passed")
        condition = 1
    else :
        condition = 0
