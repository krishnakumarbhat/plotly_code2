...
@pytest.mark.WI("WI-351612")
@pytest.mark.description("Qualification test for validation of ADC Peripheral Initialization Failure - Positive Test case")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    temp_3, temp_4 = values[1], values[2]
    time.sleep(1)
    print("")
    print("-----------------------------------WI-351612 :END-------------------------------------")
    if temp_3 == 0 and (temp_4 == 0 or temp_4 == 85) and flag:
        print("Passed")
        assert True
    else :
        print("failed")
