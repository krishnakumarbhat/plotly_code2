...
@pytest.mark.WI("WI_350216")
@pytest.mark.description("MMIC Safe startup fault- Positive Test Case")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    t1 = "MMIC_Stream.MMIC_Data.MMIC_Fault_Status.MMIC_Startup_Error.MMIC_System_Start_Fault"
    T32_R5A.add_var_watch(t1)
    temp_2 = T32_R5A.read_var(t1)
    print(t1, "=", temp_2)
    t2 = "MMIC_Stream.MMIC_Data.MMIC_Fault_Status.MMIC_Startup_Error.MMIC_Startup_Error_Cnt"
