...
@pytest.mark.WI("WI_352012")
@pytest.mark.description("Test for program Flow monitoring")
def test_MCU_Configuration_And_Supervision(Power, T32_R5A, T32_C66, Report):
    ...
    temp_3, temp_4 = values[0], values[1]
    print("")
    print("-----------------------------------WI-352012 :END-------------------------------------")
    if temp_4 == 0 and temp_3 != 0 and flag:
        print("Passed")
        assert True
    else:
        print("failed")
