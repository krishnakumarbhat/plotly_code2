...
@pytest.mark.WI("WI-348726")
@pytest.mark.description("Qualification test validation for temperature sensor consistency check - Positive Test Case")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    # Add watches and read values for all variables in a single loop
    var_values = []
    for var in var_names:
        ...
        print(f"{var} = {value}")
    temp_2, temp_3 = var_values
    print("")
    print("-----------------------------------WI-348726 :END-------------------------------------")
    if temp_2 == 85 and temp_3 == 0 and flag:
        print("Passed")
        assert True
    else:
        print("failed")
