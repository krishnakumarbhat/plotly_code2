...
@pytest.mark.WI("WI-359695")
@pytest.mark.description("Test for Thermal Monitoring Unit measurement results [GEN7_V1]")
def test_Measurement_Monitor(Power, T32_R5A, T32_C66, Report):
    ...
    variables = [
        "OnChipTemperatures.DigDspTempValue",
        "OnChipTemperatures.DigHwaTempValue",
        "OnChipTemperatures.DigHsmTempValue",
        "IoHwAb_Appl_TMU_results.immediate_temp_c.temperature[0]",
        "IoHwAb_Appl_TMU_results.immediate_temp_c.temperature[1]",
    ...
    if flag:
        ...
        print("Above Temperature values are reflecting as current values")
    else:
