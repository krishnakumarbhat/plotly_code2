...
@pytest.mark.WI("WI_353624")
@pytest.mark.description("Verify the DSS to MSS crc fault")
def test_MCU_Configuration_And_Supervision(Power, T32_R5A, T32_C66, Report):
    ...
    time.sleep(1)
    print("-----------------------------------WI-353624 :END-----------------------------------")
    if temp_2 == 0 and temp_3 == 0 and temp_4 == 0 and temp_5 == 0 and temp_6 == 0 and flag:
        print("Passed")
        assert True
    else:
        print("failed")
