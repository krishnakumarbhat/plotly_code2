...
@pytest.mark.WI("WI_342335")
@pytest.mark.description("Qualification test for validation of validation of Sensor Dead Fault - Positive Test Case")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    t1 = "MMIC_Stream.MMIC_Data.MMIC_Fault_Status.MMIC_Sensor_Dead_Fault.Sensor_Dead_Fault"
