...
@pytest.mark.WI("WI_342337")
@pytest.mark.description("Qualification test for validation of validation of Sensor Dead Fault - Negative Test Case")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    t1 = "MMIC_Stream.MMIC_Data.MMIC_Fault_Status.MMIC_Sensor_Dead_Fault.Tx_Pow_Err"
    T32_R5A.add_var_watch(t1)
    time.sleep(0.5)
    temp_2 = T32_R5A.read_var(t1)
    print(t1, "=", temp_2)
    t2 = "MMIC_Stream.MMIC_Data.MMIC_Fault_Status.MMIC_Sensor_Dead_Fault.Sensor_Dead_Fault"
    ...
    print(t3, "=", temp_4)
    t4 = "XCP_MMIC_FIT_Enable"
    T32_R5A.add_var_watch(t4)
    time.sleep(0.5)
    temp_5 = T32_R5A.read_var(t4)
    print(t4, "=", temp_5)
    print("Overwriting XCP_MMIC_FIT_Enable to XCP_MMIC_SensorDead_FIT ")
    time.sleep(0.5)
    T32_R5A.cmd("Var.set %e XCP_MMIC_FIT_Enable = 1")
    ...
    if T == 1:
        ...
        print("After sensor dead fault is set, Radar_Ctl_Data.init_status ", "=", T_1[T])
    print("")
    print("-----------------------------------WI-342337 :END-------------------------------------")
    time.sleep(5)
    condition = 0
