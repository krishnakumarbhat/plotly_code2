...
@pytest.mark.WI("WI_348496")
@pytest.mark.description("Qualification test for MMIC Data Discard - Negative Test Case")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    print(t1, "=", temp_2)
    t2 = "XCP_MMIC_FIT_Enable"
    T32_R5A.add_var_watch(t2)
    temp_3 = T32_R5A.read_var(t2)
    print(t2, "=", temp_3)
    print("Changing XCP_MMIC_FIT_Enable to XCP_MMIC_SS3_FIT ")
    T32_R5A.cmd("Var.set %e %sp XCP_MMIC_FIT_Enable = 9")
    time.sleep(3)
    temp_3 = T32_R5A.read_var(t2)
    print(t2, "=", temp_3)
    time.sleep(1)
