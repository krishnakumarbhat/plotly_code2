...
@pytest.mark.WI("WI_350697")
@pytest.mark.description("Qualification validation test for MMIC Initialization routine to configure calibration monitoring time unit")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    t1 = "MMIC_Stream.MMIC_Data.MMIC_Config_Status.Calib_Mon_Time_Unit_Cfg"
