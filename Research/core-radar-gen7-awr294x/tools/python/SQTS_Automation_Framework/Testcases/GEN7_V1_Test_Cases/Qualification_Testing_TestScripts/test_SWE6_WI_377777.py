...
@pytest.mark.WI("WI-377777")
@pytest.mark.description("Qualification test for positive validation of Idle to Faulty mode(Over Temperature Handling)")
