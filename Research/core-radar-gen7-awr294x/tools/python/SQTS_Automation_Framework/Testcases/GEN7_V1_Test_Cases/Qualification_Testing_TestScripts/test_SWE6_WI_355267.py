...
@pytest.mark.WI("WI_355267")
@pytest.mark.description("Verify the size,crc and counter sent to MSS by DSS")
def test_MCU_Configuration_And_Supervision(Power, T32_R5A, T32_C66, Report):
    ...
    temp_2, temp_3, temp_4, temp_5, temp_6 = values[0], values[1], values[2], values[3], values[4]
    time.sleep(1)
    print("-----------------------------------WI-355267 :END-----------------------------------")
