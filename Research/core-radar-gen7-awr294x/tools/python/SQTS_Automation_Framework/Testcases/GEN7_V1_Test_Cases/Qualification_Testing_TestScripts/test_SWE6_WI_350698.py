...
@pytest.mark.WI("WI_350698")
@pytest.mark.description("Qualification test validation for MMIC Initialization routine to configure Monitoring parameters")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    if T == 3:
        ...
        flag = False
    t1 = "MMIC_Stream.MMIC_Data.MMIC_Config_Status.Monitoring_Cfg"
