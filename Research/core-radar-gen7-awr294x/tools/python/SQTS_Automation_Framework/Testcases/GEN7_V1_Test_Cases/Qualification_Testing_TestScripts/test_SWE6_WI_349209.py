...
@pytest.mark.WI("WI-349209")
@pytest.mark.description("Qualification test validation for Radar Look Complete - Positive Test Case")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    var_names = [
        ...
        "MMIC_Error.Faulted",
        "MMIC_Config.cont_mode_en.contModeEn"
    ]
    ...
    print("")
    print("-----------------------------------WI-349209 :END-------------------------------------")
    if temp_2 == 0 and temp_3 == 0 and temp_4 == 0 and temp_5 == 0 and flag:
        print("Passed")
        assert True
    else:
        print("failed")
