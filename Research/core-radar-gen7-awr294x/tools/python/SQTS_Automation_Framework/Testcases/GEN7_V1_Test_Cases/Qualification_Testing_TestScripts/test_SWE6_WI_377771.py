...
@pytest.mark.WI("WI-377771")
@pytest.mark.description("Qualification test for positive validation of Degraded to Idle mode(Over Temperature Handling)")
