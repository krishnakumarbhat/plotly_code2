...
@pytest.mark.WI("WI-377781")
@pytest.mark.description("Qualification test for positive validation of Idle to Normal mode(Over Temperature Handling)")
