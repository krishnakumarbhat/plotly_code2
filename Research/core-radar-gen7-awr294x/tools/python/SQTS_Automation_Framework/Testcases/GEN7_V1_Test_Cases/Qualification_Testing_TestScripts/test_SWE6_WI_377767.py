...
@pytest.mark.WI("WI-377767")
@pytest.mark.description("Qualification test for positive validation of Degraded to Normal mode(Over Temperature Handling)")
