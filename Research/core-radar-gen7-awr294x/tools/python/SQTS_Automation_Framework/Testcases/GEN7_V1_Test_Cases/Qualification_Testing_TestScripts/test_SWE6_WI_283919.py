...
@pytest.mark.WI("WI_283919")
@pytest.mark.description("est for updation of MCU_InitializationStatus variable updated to COMPLETED(enum value = 1)")
def test_MCU_Configuration_And_Supervision(Power, T32_R5A, T32_C66, Report):
    ...
    if T == 3:
        ...
        flag = False
    t1 = "Rte_SWC_PLT_CDD_MCU_Safety_Pp_PlatformInitializationStatus_De_MCU_InitializationStatus"
