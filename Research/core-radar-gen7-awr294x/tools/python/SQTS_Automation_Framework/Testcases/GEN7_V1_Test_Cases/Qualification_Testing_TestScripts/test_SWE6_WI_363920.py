"""Python testcase for Watchdog_Manager."""
import pytest
import time
import traceback


@pytest.mark.WI("WI-363920")
@pytest.mark.description("External watchdog initialization")
def test_WATCHDOG_MANAGER(Power, T32_R5A, T32_C66, Report):
    """WinCLEAR."""
    ...
    if condition == 1:
        ...
        if Temp == 1:
            condition_1 = 1
            print(print(temp, "=", Temp))
            print("Wdt_Init_status is WDT_INIT_SUCCESS")
        elif Temp == 0:
            print(print(temp, "=", Temp))
            print("Wdt_Init_status is Wdt_Init_status")
        elif Temp == 2:
            print(print(temp, "=", Temp))
            print("Wdt_Init_status is WDT_INIT_FAILED")
        elif Temp == 3:
            print(print(temp, "=", Temp))
            print("Wdt_Init_status is  WDT_RE_INIT_FAILED")
        else:
            print(print(temp, "=", Temp))
            print("Wdt_Init_status is invalid")
