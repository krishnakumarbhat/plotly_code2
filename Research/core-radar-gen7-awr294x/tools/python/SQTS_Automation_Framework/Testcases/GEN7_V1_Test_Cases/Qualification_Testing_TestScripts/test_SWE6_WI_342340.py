...
@pytest.mark.WI("WI_342340")
@pytest.mark.description("Qualification test for validation of Safety Integrity Fault - Positive Test Case")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    t1 = "MMIC_Stream.MMIC_Data.MMIC_Fault_Status.MMIC_Safety_Integrity_Fault.saft_int_flt_sts"
