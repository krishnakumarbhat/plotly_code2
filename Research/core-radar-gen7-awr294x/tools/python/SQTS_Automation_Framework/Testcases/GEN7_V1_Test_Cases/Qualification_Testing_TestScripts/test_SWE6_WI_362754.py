...
@pytest.mark.WI("WI-362754")
@pytest.mark.description("Board revision")
def test_FAULT_MANAGER(Power, T32_R5A, T32_C66, Report):
    ...
    if condition == 1:
        ...
        if Temp == 0:
            ...
            print("Board Revision is BOARD_REV_B2")
        elif Temp == 1:
            condition_1 = 0
            condition_2 = 1
            print(print(temp, "=", Temp))
            print("Board Revision is BOARD_REV_B3")
        else:
            condition_1 = 0
            condition_2 = 0
            print(print(temp, "=", Temp))
            print("Board_Revision is not matching as per requriement")
        print("-----------------------------------WI-362754 :END-------------------------------------")
        if condition == 1 and (condition_1 == 1 or condition_2 == 1) :
