...
@pytest.mark.WI("WI_342831")
@pytest.mark.description("Qualification test validation for MMIC Loop Back Test  - Positive Test Case")
def test_FRONT_END_MANAGEMENT(Power, T32_R5A, T32_C66, Report):
    ...
    print("")
    print("-----------------------------------WI-342831 :END-------------------------------------")
    if temp_2 == 0 and temp_3 == 0 and temp_4 == 0 and temp_5 == 85 and flag:
        print("Passed")
        assert True
    else:
        print("failed")
