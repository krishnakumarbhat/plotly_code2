...
@pytest.mark.WI("WI-279816")
@pytest.mark.description("Test for Battery Low Fault")
def test_FAULT_MANAGER(Power, T32_R5A, T32_C66, Report):
    ...
    TEMP_4 = T32_R5A.read_var(temp_3)
    print("Value of RadarDiagRequest.RadarDiagShutdown when battery_low_fault is set ", TEMP_4)
    ...
    if TEMP_3 == 0:
        print("battery low fault is cleared after changing the voltage to 12")
    else :
        print("battery low fault is not cleared after changing the voltage to 12")
        flag = False
