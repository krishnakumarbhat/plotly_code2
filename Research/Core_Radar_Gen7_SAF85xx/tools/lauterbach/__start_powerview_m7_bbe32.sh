...
script_main() {
  ...
  # start "" C:\T32\bin\windows64\t32marm -c config.t32 -s start_powerview.cmm CPU=SAF85xx M7 BBE32 USER_CONFIG=default_user_config.cmm
