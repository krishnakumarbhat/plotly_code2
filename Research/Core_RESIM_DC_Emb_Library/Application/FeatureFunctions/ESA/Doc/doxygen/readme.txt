...
1. Run the python script "Jenkins/Tools/doxygen/create_doxy_file_for_feature.py" with the desired feature and customer
   as command line argument. This will create all necessary files in ESA/Doc/doxygen.

2. Call doxygen on the configuration file ESA/Doc/doxygen/html.doxy. All files in the subfolder "pages" will be
